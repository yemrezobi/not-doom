...
lint:
    ...
    cppcheck --project={{build_dir}}/compile_commands.json -I/usr/include/gtest --std=c++20 --language=c++ --enable=all -i {{build_dir}}/_deps --suppress=missingIncludeSystem --error-exitcode=1 --quiet --inline-suppr src
